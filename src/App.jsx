...
const App = () => {
  ...
  return(
    ...
    <Box  background={"#f2f3f5"}>
      {
        !data.length &&   
        <Box background={'#FFF'}  position={'absolute'} w={'100%'} h={'100%'}top={{base:'-10%',md:'-26%'}}  display={'flex'} justifyContent={'center'}alignItems={'center'}zIndex={9}>
         <CircularProgress position={'fixed'} isIndeterminate color='#DD1470' />
        </Box>
      }
        <Boshlandi/>
        <SotuvlarXiti/>
