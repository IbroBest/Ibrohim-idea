  ...
  return (
    <Box background={"#f2f3f5"}>
      <Container pb={10} maxW={{ sm:'550px',md: "750px", lg: "1116px", xl: "1576px" }}>
        ...
        <Box bg={"#fff"} p={"24px"} borderRadius={"10px"} display={"flex"}>
          {taqqoslash.map((item) => (
            <Box
            pr={'5'}
            mx={'5'}
            ...
            >
              ...
              <Box>
                <Heading fontWeight={"700"} fontSize={"18px"}>Firk mulohozalar</Heading>
                <hr />
                  <Box my={'15px'}>
                    ...
                    <StarIcon color={"#FC9700"} fontSize={"11px"} mr={'3px'}/>
                    <StarIcon color={"#FC9700"} fontSize={"11px"} mr={'3px'}/>
                    <Heading fontSize={"15px"} mt={"1px"} fontWeight={'400'}>0 fikr-mulohazalar</Heading>
                  </Box>
                  <hr />
                <Heading fontWeight={"700"} fontSize={"18px"}>Umumiy xususiyatlar</Heading>
               <Box>
